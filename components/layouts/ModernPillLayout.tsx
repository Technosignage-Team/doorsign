        ...
        <div className="relative p-8 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3 mt-2">
            {!roomStatus.isAvailable && roomStatus.currentMeeting ? (
              ...
              <button 
                onClick={() => onBook()}
                className="w-full bg-primary text-slate-200 py-5 rounded-none text-2xl font-black shadow-[0_20px_40px_rgba(19,127,236,0.3)] hover:brightness-110 active:scale-95 transition-all flex items-center justify-center gap-4 border-t border-white/20"
              >
