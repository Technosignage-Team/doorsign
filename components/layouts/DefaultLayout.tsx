              ...
              <div className="flex flex-col gap-6 pt-8 border-t border-white/5">
                <div className="flex flex-row gap-5">
                  {!roomStatus.isAvailable && roomStatus.currentMeeting ? (
                    ...
                    <button 
                      onClick={() => onBook()} 
                      className="w-full flex items-center justify-center rounded-none h-20 bg-primary text-slate-200 text-lg font-black shadow-[0_15px_40px_rgba(19,127,236,0.5)] hover:brightness-110 active:scale-95 transition-all border-t border-white/20"
                    >
